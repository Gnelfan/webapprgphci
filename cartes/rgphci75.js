...
const text = "RECENSEMENT GENERAL DE LA POPULATION EN COTE D'IVOIRE 1975";
...
const geojsonLayer1 =  L.geoJSON(pop1975JSON, {
  pointToLayer: function(feature, latlng) {
    return L.circleMarker(latlng, {
      radius: 5, fillColor: '#29221f', color: '#ffffff', weight: 1.5, opacity: 1,fillOpacity: 1
  });
  },
